<section class="testimonials content page">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="media">
<!-- 					<a class="pull-left" href="#">
					...
					<div class="media-body">
						<h4 class="media-heading">Neesa R. - Oakville</h4>
						&ldquo;
...
<!-- 					<a class="pull-left" href="#">
					...
					<div class="media-body">
						...
						&ldquo;
						I am extremely satisfied with the quality of the products and the entire shopping experience. The Solar look exactly as I envisioned. Will definitely refer friends and family
						&rdquo;
					</div>
				</div>
			</div>
